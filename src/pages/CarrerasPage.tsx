    ...
    return (
        <main className="p-6 space-y-4">
            <div className="flex items-center justify-between">
                ...
                <Button variant="outline" onClick={fetchCarreras} disabled={loading}>
            ...
            <DataTableCarreras columns={columns} data={data} globalFilterColumns={["nombre"]} onRefresh={fetchCarreras} />

            <EditCarreraDialog editing={editing} setEditing={setEditing} setData={setData} />

            <DeleteCarreraDialog open={deleteDialog}
